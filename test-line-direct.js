...
const LINE_CHANNEL_ACCESS_TOKEN = 'OEgi9cfxWeJ5hKQ97rGAkIfwYPt02/ix8e3JQkWq4nj0cB2I5xvqnik7Yod1zRu/n/8J9vuHJyhOQNlEVlDE0R555LAwzpzU4XbcVbldHDKmQiEx28OCBqfnVgC2RGqDz1tGV2x6k22VbQoIcfwAogdB04t89/1O/w1cDnyilFU=';
...
async function testLineAPI() {
    ...
    if (!LINE_CHANNEL_ACCESS_TOKEN || LINE_CHANNEL_ACCESS_TOKEN.includes('your_token_here')) {
    ...
    return new Promise((resolve, reject) => {
        ...
        console.log('🔑 Token (first 20 chars):', LINE_CHANNEL_ACCESS_TOKEN.substring(0, 20) + '...');
...
async function main() {
    ...
    try {
        ...
        if (success) {
            ...
            console.log('💡 If TestDrive form still fails, check Vercel environment variables');
        } else {
