	...
	return (
		<section className="py-16 px-4">
			<div className="max-w-7xl mx-auto">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12 md:mb-0">
					<motion.div
						className="lg:col-span-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 justify-center"
