...
export const defaultModels: CarModel[] = [
  ...
  },
  {
    ...
    specs: {
      acceleration: "7-12.5 วินาที",
      range: "490-410 กิโลเมตร",
      motor: "มอเตอร์ไฟฟ้าซิงโครนัสแม่เหล็กถาวร",
      battery: "Blade Battery 60.48-50.25 กิโลวัตต์-ชั่วโมง",
      charging: "AC Type 2 (7 kW) / DC CCS2 (80-60 kW)",
    },
    colors: [
      {
        name: "Frost White",
      ...
      },
      {
        name: "Graphite Grey",
        code: "#505050",
        gradient: "linear-gradient(145deg, #606060, #404040)",
        image: "/images/models/dolphin/dolphin-graphite-grey.png",
      },
      {
        name: "Coastal Cream",
        code: "#E8DCC5",
        gradient: "linear-gradient(145deg, #E8DCC5, #D8CDB5)",
    ...
    features: [
      {        
        title: "แบตเตอรี่ Blade Battery",
        description: "แบตเตอรี่ที่ปลอดภัยที่สุดและมีประสิทธิภาพสูง",
        image: "/images/models/dolphin/dolphin-design-card1.jpg",
      },
      {        
        title: "ระบบสั่งการด้วยเสียงภาษาไทย",
        description: "ควบคุมระบบต่างๆ ในรถได้ด้วยการสั่งงานผ่านเสียงภาษาไทย",
        image: "/images/models/dolphin/dolphin-design-card2.jpg",
      },
      {        
        title: "ระบบความปลอดภัยครบครัน",
        description: "ครบครันด้วยระบบความปลอดภัยที่ทันสมัย",
