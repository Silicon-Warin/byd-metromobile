...
export const defaultModels: CarModel[] = [
	{
		...
		gallery: {
			exterior: [
				"/images/models/byd-sealion7/exterior/exterior-img-01.webp",
				"/images/models/byd-sealion7/exterior/exterior-img-02.webp",
				"/images/models/byd-sealion7/exterior/exterior-img-03.webp",
				"/images/models/byd-sealion7/exterior/exterior-img-04.webp",
				"/images/models/byd-sealion7/exterior/exterior-img-05.webp",
			],
			interior: [
				"/images/models/byd-sealion7/interior/interior-img-01.webp",
				"/images/models/byd-sealion7/interior/interior-img-02.webp",
				"/images/models/byd-sealion7/interior/interior-img-03.webp",
				"/images/models/byd-sealion7/interior/interior-img-04.webp",
				"/images/models/byd-sealion7/interior/interior-img-05.webp",
				"/images/models/byd-sealion7/interior/interior-img-06.webp",
				"/images/models/byd-sealion7/interior/interior-img-07.webp",
			],
		},
		variants: [
			{
		...
		colors: [
			{
				...
				shadow:
					"inset 2px 2px 5px rgba(255, 255, 255, 0.5), inset -2px -2px 5px rgba(0, 0, 0, 0.1)",
				image: "/images/models/byd-seal/seal-horizon-white.png",
			},
			{
				name: "Quantum Black",
				code: "#121212",
				gradient: "linear-gradient(145deg, #222222, #000000)",
				border: "1px solid rgba(255, 255, 255, 0.7)",
				image: "/images/models/byd-seal/seal-quantum-black.png",
			},
			{
				name: "Space Grey",
				code: "#2C5C8F",
				...
				shadow:
					"inset 2px 2px 5px rgba(255, 255, 255, 0.2), inset -2px -2px 5px rgba(0, 0, 0, 0.3)",
				image: "/images/models/byd-seal/seal-space-grey.png",
			},
			{
				name: "Velocity blue",
				code: "#7AA5CD",
				...
				shadow:
					"inset 2px 2px 5px rgba(255, 255, 255, 0.3), inset -2px -2px 5px rgba(0, 0, 0, 0.2)",
				image: "/images/models/byd-seal/seal-velocity-blue.png",
			},
		],
		gallery: {
			exterior: [
				"/images/models/byd-seal/exterior/seal-ext1.webp",
				"/images/models/byd-seal/exterior/seal-ext2.webp",
				"/images/models/byd-seal/exterior/seal-ext3.webp",
				"/images/models/byd-seal/exterior/seal-ext4.webp",
				"/images/models/byd-seal/exterior/seal-ext5.webp",
			],
			interior: [
				"/images/models/byd-seal/interior/seal-int1.webp",
				"/images/models/byd-seal/interior/seal-int2.webp",
				"/images/models/byd-seal/interior/seal-int3.webp",
				"/images/models/byd-seal/interior/seal-int4.webp",
				"/images/models/byd-seal/interior/seal-int5.webp",
				"/images/models/byd-seal/interior/seal-int6.webp",
				"/images/models/byd-seal/interior/seal-int7.webp",
				"/images/models/byd-seal/interior/seal-int8.webp",
			],
		},
		features: [
			{
				title: "ระบบกันสะเทือนอัจฉริยะ",
				description: "นุ่มนวลเหนือระดับ มั่นใจทุกโค้ง",
				image: "/images/models/byd-seal/seal-design-card1.jpg",
			},
			{
				title: "ระบบกระจายแรงบิดอัจฉริยะ",
				description: "ควบคุมแม่นยำ ตอบสนองฉับไว",
				image: "/images/models/byd-seal/seal-design-card2.jpg",
			},
			{
				title: "โครงสร้างแบตเตอรี่แนบสนิท",
				description: "แข็งแกร่ง ปลอดภัย มั่นใจทุกเส้นทาง",
				image: "/images/models/byd-seal/seal-design-card3.jpg",
			},
		],
		variants: [
			{
	...
	},
	{
		...
		gallery: {
			exterior: [
				"/images/models/byd-atto3/exterior/exterior-img-01.jpg",
				"/images/models/byd-atto3/exterior/exterior-img-02.jpg",
